<?php
/**
 * Feed for migrating underwriter categories.
 *
 * @package CPR
 */
...
class Feed extends \CPR\Migration\Feed {
	 ...
	 * @var string
	 */
	protected $sync_slug = 'underwriter-category';
	 ...
	 * @var string
	 */
	protected $feed_item_class = '\CPR\Migration\Underwriter_Category\Feed_Item';
