...
add_action('http_api_curl', __NAMESPACE__ . '\sar_custom_curl_timeout', 9999, 1);
...
add_filter( 'http_request_timeout', __NAMESPACE__ . '\sar_custom_http_request_timeout', 9999 );
function sar_custom_http_request_timeout( $timeout_value ) {
	return 30; // 30 seconds. Too much for production, only for testing.
}
// Setting custom timeout in HTTP request args
add_filter('http_request_args', __NAMESPACE__ . '\sar_custom_http_request_args', 9999, 1);
