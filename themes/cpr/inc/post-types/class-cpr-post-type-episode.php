		...
		register_post_type(
			...
			[
				'labels' => [
					...
					'item_published'           => __( 'Episode published.', 'cpr' ),
					'item_published_privately' => __( 'Episode published privately.', 'cpr' ),
					'item_reverted_to_draft'   => __( 'Episode reverted to draft.', 'cpr' ),
					'item_scheduled'           => __( 'Episode scheduled.', 'cpr' ),
					'item_updated'             => __( 'Episode updated.', 'cpr' ),
