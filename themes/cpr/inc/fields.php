			...
			'children' => [
				...
				'featured_media' => new Fieldmanager_Group(
					[
						...
						'serialize_data' => false,
						'add_to_prefix' => false,
						'children' => \CPR\Fields\get_featured_media_fields(),
					]
				),
				'social_and_seo' => new Fieldmanager_Group(
					[
...
/* begin fm:post-audio-settings */
/**
 * `post-audio-settings` Fieldmanager fields.
 */
function cpr_fm_post_audio_settings() {
	$fm = new Fieldmanager_Group(
		[
			'name' => 'post-audio-settings',
			'serialize_data' => false,
			'add_to_prefix' => false,
			'tabbed' => 'vertical',
			'children' => [
				'settings' => new Fieldmanager_Group(
					[
						...
						'children' => [
							...
							'podcast_id' => new Fieldmanager_Select(
								[
									'label' => __( 'Podcast', 'cpr' ),
									'description' => __( 'Select a podcast.', 'cpr' ),
									'datasource' => new Fieldmanager_Datasource_Term(
										[
											'taxonomy' => 'podcast',
											'taxonomy_save_to_terms' => true,
	...
	$fm->add_meta_box( __( 'Settings', 'cpr' ), [ 'podcast-episode', 'show-episode', 'show-segment' ] );
}
add_action( 'fm_post_podcast-episode', 'cpr_fm_post_audio_settings' );
add_action( 'fm_post_show-episode', 'cpr_fm_post_audio_settings' );
add_action( 'fm_post_show-segment', 'cpr_fm_post_audio_settings' );
/* end fm:post-audio-settings */

/* begin fm:post-show-segment-settings */
/**
 * `post-show-segment-settings` Fieldmanager fields.
 */
function cpr_fm_post_show_segment_settings() {
	$fm = new Fieldmanager_Group(
		[
			'name' => 'post-show-segment-settings',
			'serialize_data' => false,
			'add_to_prefix' => false,
			'tabbed' => 'vertical',
			'children' => [
	...
	$fm->add_meta_box( __( 'Settings', 'cpr' ), [ 'show-segment' ] );
}
add_action( 'fm_post_show-segment', 'cpr_fm_post_show_segment_settings' );
/* end fm:post-show-segment-settings */
