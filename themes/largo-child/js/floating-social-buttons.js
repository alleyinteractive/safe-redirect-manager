...
(function() {
    ...
    var checkPosition = function() {
        ...
        // return scrollTop > offsets[0] && (scrollBottom < offsets[1] + 1000);
        return scrollTop > offsets[0];
    };

    var checkViewPort = function() {
        return $(window).width() > window.floating_social_buttons_width.min;
    };
    ...
    var getOffsetTop = function() {
        ...
        return window.floating_social_buttons_top_element.offset().top
            ...
            - stickyNavHeight;
        // We want it to appear when the top area is no longer visible,
        // not when the top area is no longer inside the viewport.
    }
